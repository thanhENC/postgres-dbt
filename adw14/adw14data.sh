...
# cp install.sql ./data/install.sql
...
# cp update_csvs.rb ./data/update_csvs.rb
...
# Create the OLTP database and tables
export OLTP_DB_CONNECTION_STRING=postgresql://$OLTP_DB_USER:$OLTP_DB_PASSWORD@$OLTP_DB_HOST:5432/$OLTP_DB_NAME
psql $OLTP_DB_CONNECTION_STRING -f install.sql
